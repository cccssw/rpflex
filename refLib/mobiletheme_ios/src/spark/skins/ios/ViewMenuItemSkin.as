...
public class ViewMenuItemSkin extends spark.skins.mobile.ButtonSkin
{
    ...
    public function ViewMenuItemSkin()
    {
        ...
        switch (applicationDPI)
        {
            case DPIClassification.DPI_320:
            {
                ...
                downBorderSkin = spark.skins.ios320.assets.Button_fillUp;
            ...
            case DPIClassification.DPI_240:
            {
                ...
                downBorderSkin = spark.skins.ios240.assets.Button_fillUp;
            ...
            default:
            {
                ...
                downBorderSkin = spark.skins.ios160.assets.Button_fillUp;
    ...
    override protected function layoutContents(unscaledWidth:Number, unscaledHeight:Number):void
    {
        ...
        var shadowOffset:int = (currentState.indexOf("down") == 0) ? -1 : 1;
        setElementSize(borderBackground, unscaledWidth, unscaledHeight);
        setElementPosition(labelDisplayShadow, labelDisplay.x, labelDisplay.y + shadowOffset);
    }
